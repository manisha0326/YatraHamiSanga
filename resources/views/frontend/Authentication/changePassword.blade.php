        ...
        <div class="container" style="margin-top:94px;">
            <div class="row g-5">
                ...
                <div class="col-md-6 mb-4">
                    <div>
                        <img src="../image/signup.png" alt="" style="width: 600px; height: 700px;" />
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    @endif
                    <h2 style="text-align: center; color: #262586; font-family: Roboto; margin: 10px;">"Reset Your Password"
                    </h2>
                    <form method="POST" action="{{ route('changePassword') }}" method="post"
