        ...
        <div class="container" style="margin-top:94px;">
            <div class="row g-5">
                ...
                <div class="col-md-6 mb-4">
                    <div>
                        <img src="../image/forgetPassword.png" alt="" style="width: 600px; height: 600px;" />
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    @endif
                    <h2 style="text-align: center; color: #262586; font-family: Roboto; margin: 10px;">"Forgot Your
                        Password?"</h2>
                    <p style="text-align: center; font-family: Roboto; font-size: 20px; margin-top: 20px;">Don’t worry,
                        we’ll send you an OTP to recover your password.</p>
