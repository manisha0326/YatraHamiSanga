        ...
        <div class="container" style="margin-top:94px;">
            <div class="row g-5">
                ...
                <div class="col-md-6 mb-4">
                    <div>
                        <img src="../image/login.png" alt="" style="width: 600px; height: 600px;" />
                    </div>
                    ...
                    <form action="{{ route('login') }}" method="post"
                        ...
                        <div class="mb-3 form-check"
                            ...
                            <div>
                                <a href="{{ route('forgetPassword') }}"
                                    style="text-decoration: none; color: #262586; font-family: poppins;">Forgot
                                    Password?</a>
                            </div>
                        </div>
                        ...
                        <div class="text-center" style="margin-top: 50px;">
                            <p style="margin-top: 50px; font-family: poppins; color: #262338">
                                ...
                                <a style="text-decoration: none; font-family: poppins;" href="{{ route('signup') }}"><span
                                        style="color: #262586; font-weight: 600">SignUp</span></a>
                            </p>
                        </div>
                    </form>
                </div>
