          ...
          ">
            ...
            <div class="row" style="margin-top: 50px">
                ...
                <div class="col-md-9">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="../Car/Car1/car1.1.html" class="text-decoration-none text-dark">
                                <div class="vehicle-card">
                                    <img src="../image/Car/car1.png" alt="" />
                                    <div class="content">
                                        <h5>
                                            Toyota Glanza
                        ...
                        <div class="col-md-6">
                            <a href="../Car/Car2/car2.1.html" class="text-decoration-none text-dark">
                                <div class="vehicle-card">
                                    <img src="../image/Car/car2.jpg" alt="" />
                                    <div class="content">
                                        <h5>
                        ...
                        <div class="col-md-6">
                            <a href="../Car/Car3/car3.1.html" class="text-decoration-none text-dark">
                                <div class="vehicle-card">
                                    <img src="../image/Car/car3.png" alt="" />
                                    <div class="content">
                                        <h5>
                                            Honda Amaze
                                            <span class="badge bg-light text-dark">Car</span>
                        ...
                        <div class="col-md-6">
                            <a href="../Car/Car4/car4.1.html" class="text-decoration-none text-dark">
                                <div class="vehicle-card">
                                    <img src="../image/Car/car4.jpg" alt="" />
                                    <div class="content">
                                        <h5>
                                            Hyundai VERNA
                                            <span class="badge bg-light text-dark">Car</span>
