        ...
        <div class="container_apache" style="margin-top:150px;">
            <div class="main-section">
                ...
                <div class="details-section">
                    ...
                    <p><span style="font-size: 22px; font-weight:bolder;color:#212529 ">Price: </span>NRS
                        {{ $brand->price }} / day</p>
            ...
            <h2 style="margin-top: 40px; margin-bottom: 40px; color: #161616; font-family: roboto;"><span
                    style="color:#262586 ;">Rating</span> by our previous <span style="color:#262586 ;">customers</span>
            </h2>
            <div>
                <div class="carousel">
                    <div class="reviews">
                        <div class="review active">
                            ...
                            <div class="review-text">
                                I had a fantastic experience with Yatra Hami Sanga. The booking process was easy and the car
                                was in great condition. Highly recommended!
                            </div>
                        </div>
                        ...
                        <div class="review">
                            ...
                            <div class="review-text">
                                Yatra Hami Sanga made it easy to rent a car for my weekend trip. The driver was professional
                        ...
                        <div class="review">
                            ...
                            <div class="review-text">
                                Yatra Hami Sanga has potential, but my experience wasn't great. The driver was late and the
                                car's AC wasn't working. Customer care took too long to respond.
                            </div>
                        </div>
                    </div>
                </div>
