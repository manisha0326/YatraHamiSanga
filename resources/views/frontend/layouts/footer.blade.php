    ...
    <footer style="height: 405px; background-color: #fcfcfc; font-family: Roboto">
        <div class="d-flex align-items-center">
            <div class="container d-flex justify-content-between align-items-center" style="margin-top:20px;">
                <a href="Home.html">
                    <img src="{{ asset('image/ttt.svg') }}" alt="" style="width: 260px; margin-top: 80px" /></a>

                <!-- <a class="navbar-brand fw-bold fs-1 text-white" href="#">LOGO</a> -->
                <div class="d-flex" style="gap: 262px; margin-top: 50px; color: #262338">
                    ...
                    <div class="two" style="margin-right: 140px; color: #262338">
                        <div style="font-weight: bold">Additional Links</div>
                        <a href="AboutUs.html" class="footer-link" style="margin-top: 40px">About Us</a><br />
        ...
        <div class="social-media">
          ...
          ">
                Social Media:
                <a href="{{ asset('image/facebook.svg') }}">
                    <img src="{{ asset('image/facebook.svg') }}" alt="" />
                </a>
                <a href="{{ asset('image/instagram.svg') }}">
                    <img src="{{ asset('image/instagram.svg') }}" alt="" />
                </a>
                <a href="{{ asset('image/youtube.svg') }}">
