    ...
    <footer style="height: 400px; background-color: #fcfcfc; font-family: Roboto">
        <div class="d-flex align-items-center">
            <div class="container d-flex justify-content-between align-items-center" style="margin-top:20px;">
                ...
                <div class="d-flex" style="gap: 400px; margin-top: 50px; color: #262338">
                    ...
                    <div class="two" style="margin-right: 140px; color: #262338">
                        <div style="font-weight: bold">Additional Links</div>
                        <a href="{{ route('aboutus') }}" class="footer-link" style="margin-top: 40px">About Us</a><br />
                        <a href="{{ route('rental.index') }} " class="footer-link">Rental</a><br />
