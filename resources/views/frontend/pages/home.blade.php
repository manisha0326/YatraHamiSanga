    ...
    <section style="margin-top:94px; ">
        ...
        <div class="containers">
            ...
            <div class="sub-container">
                ...
                <button class="see-more-btn" style="background-color:#a8baff00;"><a href="{{ route('aboutus') }}"
                        style="text-decoration: none;background-color:#a8baff00;">See More
                        &rarr;</a></button>
            </div>
        </div>
                        ...
                        @if ($brand)
                            <div class="col-md mx-2 mb-4">
                                <div class="card h-100" style="max-width:225px;">
                                    <img src="{{ asset('storage/' . $brand->image) }}" class="card-img-top"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="{{ route('rental.index', $category->slug) }}" class="btn btn-primary">Click
                                            Here</a>
                                    </div>
                                </div>
                            </div>
