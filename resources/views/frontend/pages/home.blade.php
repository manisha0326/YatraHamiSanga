...
@section('content')
      <section style="margin-top:94px; ">
        ...
        <div class="conatiner2" style="margin-top: 40px;">
            <div class="container" style="display: flex; align-items: center;justify-content: space-between;">
                ...
                <button class="see-more-btn"><a href="{{ route('Rental.Bike') }}"
                    ...
                    <div class="col-md mx-2 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{ route('Rental.Bike') }}" class="btn btn-primary">Click Here</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md mx-2 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">It's design and innovation made it a global icon of stylish.</p>
                                <a href="{{ route('Rental.Scooter') }}" class="btn btn-primary">Click Here</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md mx-2 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">It is the confortable and stylish car with manual and automatic
                                    gearboxes.</p>
                                <a href="{{ route('Rental.Car') }}" class="btn btn-primary">Click Here</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md mx-2 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">It's is a tough, stylish SUV with strong performance and modern
                                    features.</p>
                                <a href="{{ route('Rental.Scropio') }}" class="btn btn-primary">Click Here</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md mx-2 mb-4">
                        <div class="card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">This vehicle is known for its performance, realiability and
                                    versatility.</p>
                                <a href="{{ route('Rental.Hiace') }}" class="btn btn-primary">Click Here</a>
                            </div>
                        </div>
                    </div>
                </div>
