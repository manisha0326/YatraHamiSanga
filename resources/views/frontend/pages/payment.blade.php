                ...
                <div class="col-md-6">
                    ...
                    <form action="{{ route('booking.store') }}" method="post"
                        ...
                        <div class="mb-4">
                            ...
                            <select id="vehicleType" class="form-select @error('vehicleType') is-invalid @enderror"
                                onchange="loadModels(this.value)" name="vehicleType">
                            ...
                            <div id="dynamicModelsContainer" style="margin-top: 15px; display: none">
                                <label for="dynamicModels" class="form-label" style="color: #262338">Select Vehicle
                                    Model</label>
                                <select id="dynamicModels" class="form-select @error('vehicleModel') is-invalid @enderror"
                                    name="vehicleModel">
                        ...
                        <div class="mb-4">
                            <div>
                                ...
                                <select name="bookingType" id="bookingType" class="form-select"
                                    onchange="handleBookingTypeChange(this)">
                        ...
                        <div id="perDayBlock" class=" mb-4">
                            <div class=" mb-4">
                                ...
                                <input type="date" class="form-control @error('pickupDate') is-invalid @enderror"
                        ...
                        <div id="perHourBlock" class=" mb-4 d-none">
                            <div>
                                ...
                                <input type="number" min="1" max="12" name="hour" id="hour"
                        ...
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input @error('exampleCheck1') is-invalid @enderror"
                                                ...
                                                <div class="row g-3 text-center">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <button type="submit" style="border: none; background: none;">
                                                            <img src="{{ asset('image/paymentsTypeimg/khaltiii.png') }}"
                                                                class="img-fluid payment-logo" alt="Khalti" />
                                                        </button>
