                ...
                <div class="col-md-6 mb-4">
                    ...
                    <div style="margin-top: 20px;">
                        <div style="display: flex; gap: 20px; align-items: center; margin-bottom: 10px;">
                            <img src="./image/call_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg" alt="" />
                            <p style="color: #262338; margin: 0;">
                                9863482905,9862090518
                            </p>
                        </div>
                        <div style="display: flex; gap: 20px; align-items: center; margin-bottom: 10px;">
                            <img src="./image/mail_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg" alt="" />
                            <p style="color: #262338; margin: 0;">
                                yatra9980@gmail.com
                            </p>
                        </div>
                        <div style="display: flex; gap: 20px; align-items: center">
                            <img src="./image/location_on_24dp_1F1F1F_FILL0_wght400_GRAD0_opsz24.svg" alt="" />
