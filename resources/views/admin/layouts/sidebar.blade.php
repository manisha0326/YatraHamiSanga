<aside class="app-sidebar bg-body-secondary shadow d-flex flex-column" data-bs-theme="dark" style="height: 100vh;">
    <div class="sidebar-brand p-3" style="height: 86px;">
        <a href="/" class="brand-link">
            <img src="{{ asset('image/dashboardlogo.png') }}" alt="AdminLTE Logo" class="brand-image opacity-75 shadow"
        ...
        <nav class="mt-4" style="padding:0px 10px;">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-submenu {{ request()->is('admin/category/*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview submenu">
                        <li class="nav-item"><a href="{{ route('admin.category.create') }}"
                                class="nav-link {{ request()->is('admin/category/create') ? 'active' : '' }}">Create</a>
                        </li>
                        <li class="nav-item"><a href="{{ route('admin.category.view') }}"
                                class="nav-link {{ request()->is('admin/category/view') ? 'active' : '' }}">View</a>
                        </li>
                ...
                <li class="nav-item has-submenu {{ request()->is('admin/brand/*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview submenu">
                        <li class="nav-item"><a href="{{ route('admin.brand.create') }}"
                                class="nav-link {{ request()->is('admin/brand/create') ? 'active' : '' }}">Create</a>
                        </li>
                        <li class="nav-item"><a href="{{ route('admin.brand.view') }}"
                                class="nav-link {{ request()->is('admin/brand/view') ? 'active' : '' }}">View</a></li>
